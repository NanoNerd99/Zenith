...
function Collocation() {
    ...
    return (
        <Grid
            ...
            alignItems="center"
            sx={{height: "59px", width: "852px", marginRight: 2}}
        >
            <Grid
                container
                direction="row"
                    ...
                    >
                        <Tabs value={value} onChange={handleChange} centered>
                            {collocationData.map((item, index) => {
                                return <Tab key={index} label={item} sx={{textTransform: "none", fontSize: 15}}/>;
                            })}
                        </Tabs>
                    </Grid>
                </Grid>
            ...
            <Grid container sx={{marginTop: 2}}>
                ...
                />
                <Typography>Prices are calculated for one adult.</Typography>
            </Grid>
            <Grid container sx={{marginTop: 2}}>
