        ...
        >
            ...
            >
                <TabContext value={value}>
                    ...
                    >
                        <TabList centered onChange={handleChange} orientation={condTabOrientation} variant={"fullWidth"}
                                 sx={{marginTop: 1.5, paddingRight: {lg: 12, xs: 0}, paddingLeft: {lg: 12, xs: 0}}}>
                            {mainMenuData.map((item, index) => {
                                return (
                                    <Tab
                                        key={index}
                                        sx={{fontSize: {lg: 12}, textTransform: "none"}}
                                        label={item.label}
                                        icon={item.icon}
                                        value={item.value}
                                    />
                    ...
                    <Box component={Grid} sx={{justifyContent: "center"}}>
                        <TabPanel value="1">
                            <Enterflight/>
                        </TabPanel>
